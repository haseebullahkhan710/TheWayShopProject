...
namespace TheWayShopProject.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.CATEGORY_FID = new SelectList(db.Categories, "CATEGORY_ID", "CATEGORY1");
            return View();
        }
        ...
        public ActionResult Create(Product product)
        {
            ...
            ViewBag.CATEGORY_FID = new SelectList(db.Categories, "CATEGORY_ID", "CATEGORY1", product.CATEGORY_FID);
            return View(product);
        }
